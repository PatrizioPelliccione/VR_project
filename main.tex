...
\noindent {\em Contribution beyond the state of the art}:  
...
\noindent {\em Contribution beyond the state of the art}:  Large scale advances in these fields have been focused mainly
...
\noindent {\em \underline{Evolution.}} 
...
(L'Aquila University, Italy), Antonia Bertolino, Felicita di Giandomenico and Stefania Gnesi (Italian National Research Council), and Carlo Ghezzi, Luciano Baresi, Elisabetta Di Nitto and Raffaela Mirandola (Politecnico di Milano). %, and Alessandro Fantechi (University of Florence).
